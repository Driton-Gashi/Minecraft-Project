...
?>
        <div id="collection" class="collection">
            ...
            <div class="collection-content">
                ...
                ?>
                    <div class="post ">
                        <form action="../php/create-<?= $args['type'] ?>.php" class="post-form" method="post" enctype="multipart/form-data">

                            <h1 class="name-label"><?= $args['type'] ?> name:</h1>
                            <input type="text" name="<?= $args['type'] ?>_name" class="mob_name" placeholder="<?= $args['type'] ?> name here...">
                        ...
                        <div class="collection-box">
                            ...
                            <div class="collection-box-footer">
                                <span class="view-wrapper"><i class="bi bi-eye-fill"></i>
                                    ...
                                    <a onclick="like(<?= $mob['id'] ?>,'<?= $args['type'] ?>')" class="like-wrapper"><i class="bi <?= " bi-suit-heart " ?>like"></i>
                                    </a>
